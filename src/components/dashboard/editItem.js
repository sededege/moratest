                        ...
                        <div className='col-span-2  flex flex-col justify-between'>
                            <div className='col-span-2'>
                                <div className='col-span-2 mb-2 flex gap-2 '>
                                    {
                                        colores ? colores.map((a, index) =>
                                            <div onClick={() => change(index)} className={` ${colorselect === a.name ? 'border-blue-200 text-blue-200' : 'border-gray-200 bg-gray-200'} p-2 flex gap-2 rounded-lg border-2 w-20 items-center`}>
