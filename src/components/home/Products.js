                            ...
                            <div className='gap-2 flex flex-col mb-5'>
                                ...
                                <div className='p-2 rounded-b-lg relative '>
                                    <div className='flex justify-between items-center '>
                                        <p className='font-regular text-gray-500 w-[200px] text-[0.9rem]'>{a.name} {a.color[0].name}</p>
                                        {
                                    ...
                                    <div className='flex h-full justify-between  items-center mt-2 '>
                                        {
                                            a.oferta !== '0'
                                              ? <div className='flex gap-2 items-center'>
                                                <p className='text-[1.2rem] md:text-[1.2rem] text-booty font-semibold'>$ {Math.round((a.precio * (100 - (a.oferta))) / 100)}</p>
                                                <p className='text-[1rem]  text-gray-500 line-through'>$ {a.precio}</p>
