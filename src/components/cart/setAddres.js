            ...
            <form className="w-full fixed z-[99]  max-w-lg p-10 bg-white rounded-lg">
                <div className="flex  flex-wrap -mx-3 mb-6">
                    ...
                    <div className="w-full px-3 mb-6 md:mb-0">
                        ...
                        <input value={alias} onChange={(e) => setAlias(e.target.value)} required className="appearance-none block w-full bg-gray-200 text-gray-700 border  rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="grid-first-name" type="text" placeholder="Escribe un nombre" />
                    </div>
                    <div className="w-full px-3 mt-3">
                        <label className="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" >
                            Calle*
                        </label>
                        <input value={dire} onChange={(e) => setDire(e.target.value)} required className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" type="text" placeholder="Dirección" />
                    </div>
                ...
                <div className='justify-end gap-2 flex items-center mt-4'>
                    <button onClick={cerrarEdit} className="relative  items-center justify-center ml-100 bg-red-500 hover:bg-red-700 border-red-500 hover:border-red-700 text-sm border-4 text-white py-1 px-2 rounded" type="button">
                        Cancelar                </button>
                    <button onClick={guardarEdit} className="relative  items-center justify-center ml-100 bg-teal-500 hover:bg-teal-700 border-teal-500 hover:border-teal-700 text-sm border-4 text-white py-1 px-2 rounded" type="button">
                        Guardar
                    </button>
                </div>
