                                                        ...
                                                        <div className='flex gap-2 w-full'>
                                                            {
                                                                thisProduct.color && thisProduct.color.map(a =>
                                                                    <div key={a.id} onClick={() => setFiltroColor(a.name)} className={` ${filtrocolorselect === a.name
? `border-2
                                             ${borderselect(a.name)} rounded-full`
                                                        ...
                                                        <div className='gap-4 flex'>

                                                            {
                                                                thisProduct.color && filtrocolorselect
                                                                  ? thisProduct.color.filter(a => a.name === filtrocolorselect)[0].tallas.map(a => (
                                                                    a.stock > 0
                                                                      ...
                                                                      : <div key={a.id} className='bg-gray-200 border-2 flex cursor-pointer w-8 h-8 rounded-lg  items-center justify-center'>
