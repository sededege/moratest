...
const Detalle = () => {
    ...
    return (
        ...
        <div className=' fixed'>
            <div className='w-[80vw] ml-[10vw] flex px-20 justify-start mt-[10vh] overflow-hidden'>
 ...
 */}                <nav className="flex p-2 ml-4" aria-label="Breadcrumb" >
            ...
            {
                thisProduct ?
                    <div className='flex w-[80vw] h-full px-20 ml-[11vw]'>
                        <div className='flex '>
 ...
 */}                        </div>
                        ...
                        <div className='flex flex-col  w-full  items-center gap-6'>
                            ...
                            {
                                toggle === 'Info' ?
                                    <div className=' w-[35vw]  p-5 h-full '>
                                            ...
                                            <div className='flex justify-between items-center gap-20 mt-10'>
                                             ...
                                             ${borderselect(a.name)} rounded-full` : 'border-2 border-white rounded-full'} `}>
                                                ...
                                                <div className='flex flex-col gap-4 '>
                                                    ...
                                                    <div className='flex  gap-4'>
                                                        <div onClick={cantidad > 1 ? () => setCantidad(cantidad - 1) : console.log('nada')} className='flex cursor-pointer w-8 h-8 rounded-lg bg-booty items-center justify-center'>
